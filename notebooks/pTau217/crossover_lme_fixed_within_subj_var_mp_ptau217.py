...
def run(cfg, sample_size, m_group1, m_group2, seed):
    ...
    if cfg["log_transform"] == True:
        df["value"] = df["value"].apply(lambda x: np.log(x+1))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--log-transform", action='store_true', help='Enable log transform on synthesized data')
    ...
    apply_log_transform    = args.log_transform
    ...
    for ratio in ratios:
        ...
        cfg["log_transform"]   = apply_log_transform
